# Rename all graph input files to their recognized graph type names
...
if ($errorCount -gt 0) {
    Write-Host "  Errors/Skipped: $errorCount files" -ForegroundColor Red
} else {
    Write-Host "  Errors/Skipped: $errorCount files" -ForegroundColor Green
}
Write-Host "================================" -ForegroundColor Cyan
