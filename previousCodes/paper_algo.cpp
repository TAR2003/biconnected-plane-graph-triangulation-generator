...
ll geenralTriangulationsCall = 0;
ll findLeftMostBlockingChordCall = 0;
ll flipChordCall = 0;
...
int main()
{
    ...
    for(ll i = 4; i <= 10 ; i++) {
        ...
        calculate(i);
        cout << "geenralTriangulationsCall: " << geenralTriangulationsCall << endl;
        cout << "findLeftMostBlockingChordCall: " << findLeftMostBlockingChordCall
             << endl;
        cout << "flipChordCall: " << flipChordCall << endl;
        cout << "----------------------------------------" << endl;
    }
